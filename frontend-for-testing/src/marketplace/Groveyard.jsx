...
const Groveyard = () =>
  ...
  // }
  {
    let [NFTContractAddress, setNFTContractAddress] = useState(
      "0xb1bFcbF0Dda66Ac0A0614CC13E621939229AC118"
    );
    let [Signer, setSigner] = useState();
    let [TokenURI, setTokenURI] = useState(
      "https://m2irnp2ebykskad7mct4tq45cesgaykyzsukm3dnbmxwraydkttq.akrd.net/ZpEWv0QOFSUAf2CnycOdESRgYVjMqKZsbQsvaIMDVOc"
    );
